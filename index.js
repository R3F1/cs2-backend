...
// Strona testowa dla przeglądarki
app.get('/', (req, res) => {
  res.send('<h1 style="font-family: sans-serif; color: #1A73E8; text-align: center; margin-top: 20%;">Serwer CS2 REFITV API Dziala i nasluchuje!</h1>');
});

// Główny endpoint logowania
...
// Powrót ze Steama i odesłanie do aplikacji
app.get('/auth/steam/return', (req, res) => {
  ...
  if (claimedId && appReturnUrl) {
    ...
    res.send('Blad: Brak danych ze Steam. Sprobuj zalogowac sie ponownie.');
  }
});
